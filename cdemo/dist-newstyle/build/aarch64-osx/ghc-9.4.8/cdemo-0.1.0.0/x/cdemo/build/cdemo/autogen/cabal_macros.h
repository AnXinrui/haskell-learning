...
/* package cdemo-0.1.0.0 */
#ifndef VERSION_cdemo
#define VERSION_cdemo "0.1.0.0"
#endif /* VERSION_cdemo */
#ifndef MIN_VERSION_cdemo
#define MIN_VERSION_cdemo(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_cdemo */
...
#define CURRENT_COMPONENT_ID "cdemo-0.1.0.0-inplace-cdemo"
